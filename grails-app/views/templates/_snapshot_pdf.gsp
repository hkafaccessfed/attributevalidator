<html>
  ...
  <body>
    ...
    <div style="background-color:#495666; padding: 12px;">
      <h1>Hong Kong Access Federation - Attribute Validation</h1>
    ...
    <p>
      For technical requirements associated with each attribute please refer to <a href="http://hkafaccessfed.github.io/info/attributes">http://hkafaccessfed.github.io/info/attributes</a>
    </p>
