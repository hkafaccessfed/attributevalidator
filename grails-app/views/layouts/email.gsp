                          ...
                          <td valign="top" class="preheaderContent" style="color:#505050; font-family:Arial; font-size:10px; line-height:100%; text-align:left;">
                              <table border="0" cellpadding="10" cellspacing="0" width="100%">
                                <tr>
                                    <td valign="top">
                                        <div >
                                           An important message from the Hong Kong Access Federation<br> 
                                           [APPLICATION NAME]
                                        </div>
                                      </td>
                                      <td valign="top" width="190">
                                        <div >
                                            Do you need help with the Federation?<br /><a href="mailto://support@hkaf.edu.hk" target="_blank"> email the HKAF Support service</a>.
                                          </div>
                                      </td>
                                  </tr>
                              </table>
